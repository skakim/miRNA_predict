...
methods.names <- c("RF","SVM","NB","KNN","J48","GLM")
color <- rainbow(length(methods.names))   
models.allfeat <- list( RF=rf.fit, SVM=svm.fit, NB=nb.fit, KNN=knn.fit, J48=j48.fit, GLM=glm.fit)
models.top <- list( RF=rf.top.fit, SVM=svm.top.fit, NB=nb.top.fit, KNN=knn.top.fit, J48=j48.top.fit, GLM=glm.top.fit)
...
models.allfeat.predict <- list( RF=rf.predict.test, SVM=svm.predict.test, NB=nb.predict.test, KNN=knn.predict.test, J48=j48.predict.test, GLM=glm.predict.test)
...
models.top.predict <- list( RF=rf.top.predict.test, SVM=svm.top.predict.test, NB=nb.top.predict.test, KNN=knn.top.predict.test, J48=j48.top.predict.test, GLM=glm.top.predict.test)
...
auc.allFeat <- CompareModelsAUCScore(models.allfeat,data.test.descr,data.test.class,plotROC=FALSE,filename="figure_roc_testset.pdf")
auc.top <- CompareModelsAUCScore(models.top,data.test.descr[,colnames(data.train.descr.topFeat)],data.test.class,plotROC=FALSE,filename="figure_roc_testset_top.pdf")
